...
proc create_root_design { parentCell } {
  ...
  # Create instance: my_adder_0, and set properties
  set my_adder_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:my_adder:1.0 my_adder_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins my_adder_0/S0_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins my_adder_0/s0_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins my_adder_0/s0_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs my_adder_0/S0_AXI/S0_AXI_reg] SEG_my_adder_0_S0_AXI_reg
...
preplace inst my_adder_0 -pg 1 -lvl 3 -y 130 -defaultsOSRD
...
preplace netloc rst_processing_system7_0_50M_peripheral_aresetn 1 1 2 450 240 NJ
